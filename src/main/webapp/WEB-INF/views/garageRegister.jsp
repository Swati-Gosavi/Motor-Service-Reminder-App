...
<body class="signup-body">
    <div class="agile-signup">    
        <div class="content2">
            ...
            <form action="afterGarageRegistration" method="post">
            ...
            <div class="garage-vehicle-buttons">
                <a href="adminLoginPage" class="btn btn-outline-primary">Admin Login</a>
                <a href="/MotorServiceReminderApp/" class="btn btn-outline-primary ml-2">Vehicle Login</a>
            </div>
            <p class="register-message">Already registered? <a href="garageLoginPage">Login here</a></p>
        </div>
        <!-- footer -->
        <div class="copyright">
