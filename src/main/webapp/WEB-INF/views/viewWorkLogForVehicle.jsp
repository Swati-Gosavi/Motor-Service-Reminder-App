            ...
            <% List<Worklog> worklogList = (List<Worklog>)request.getAttribute("worklogList");
               for(Worklog worklog : worklogList) { %>
                <tr>
                    ...
                    <td><a href="deleteVehicleWorklog/<%=worklog.getLogId()%>">Delete</a></td>
                </tr>
            <% } %>
        </tbody>
					  </table>
