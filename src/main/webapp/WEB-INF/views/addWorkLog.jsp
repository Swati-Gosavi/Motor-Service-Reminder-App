					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									<form action="afterAddWorkLogSubmit" method="post"> 
										...
										<div class="form-group"> 
											<label for="exampleInputEmail1"> Garage Contact Number</label> 
											<input type="text" name="garageContact" class="form-control" id="garageContact" placeholder="Garage Contact Number"> 
										</div> 
										<div class="form-group"> 
